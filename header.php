    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <?php foreach ($lescontinents as $continent_c): ?>
            <a class="dropdown-item" href="index2.php?continent=<?php echo $continent_c->Continent; ?>"><?php echo $continent_c->Continent; ?></a>
          <?php endforeach; ?>
